...
├── src/
│   ├── components/
│   │   ├── CodeEditor.tsx          # Monaco editor for file editing
│   │   ├── ViewCodeEditor.tsx      # Monaco editor for read-only viewing
│   │   ├── Dropzone.tsx            # Drag-and-drop file upload
│   │   ├── UploadPlugin.tsx        # Upload interface wrapper
│   │   ├── LanguageSelect.tsx      # Language selector for editor
│   │   ├── ThemeSelect.tsx         # Theme selector for editor
│   │   └── states/                 # Upload state components
│   ├── layouts/
│   │   └── BaseLayout.astro
│   ├── lib/
│   │   ├── editor.ts               # Editor utilities
│   │   ├── language.ts             # Language detection
│   │   ├── request.ts              # Client-side API requests
│   │   └── server/
│   │       └── request.ts          # Server-side API requests
│   ├── pages/
│   │   ├── [id].astro              # Upload page (dynamic route)
│   │   ├── edit/
│   │   │   ├── [id].astro          # Edit page (dynamic route)
│   │   │   └── error/
│   │   │       └── index.astro
│   │   ├── view/
│   │   │   └── [id].astro          # View page (dynamic route)
│   │   ├── 404.astro
│   │   └── error.astro
│   ├── resources/
│   │   ├── Dracula.json            # Dracula theme
│   │   └── GitHubDark.json         # GitHub Dark theme
│   └── styles/
│       └── global.css
├── astro.config.mjs
├── package.json
